...
pub const Env = struct {
    ...
    pub fn load(map: *const Map) Env {
        ...
        return .{
            ...
            .host = host,
            .port = port,
            .postgres_url = get(map, "POSTGRES_URL", "postgres://postgres:postgres@localhost:20001/benchmarks"),
            .mongodb_url = get(map, "MONGODB_URL", "mongodb://localhost:20002"),
            .mongodb_db = get(map, "MONGODB_DB", "benchmarks"),
            .redis_url = get(map, "REDIS_URL", "redis://localhost:20003"),
            .cassandra_contact_points = get(map, "CASSANDRA_CONTACT_POINTS", "localhost:20004"),
