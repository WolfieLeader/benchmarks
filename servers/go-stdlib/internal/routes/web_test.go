...
func webMux() *http.ServeMux {
	...
	RegisterWeb(mux, testSecret)
	return mux
}

func do(t *testing.T, mux *http.ServeMux, req *http.Request) (*httptest.ResponseRecorder, string) {
	t.Helper()
...
func TestHTML(t *testing.T) {
	rec, body := do(t, webMux(), httptest.NewRequest(http.MethodGet, "/html", nil))
...
func TestCompute(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			rec, body := do(t, mux, httptest.NewRequest(http.MethodGet, "/compute?"+tc.query, nil))
...
func TestValidate(t *testing.T) {
	...
	rec, body := do(t, mux, httptest.NewRequest(http.MethodPost, "/validate", strings.NewReader(valid)))
	if rec.Code != http.StatusOK {
	...
	rec, body = do(t, mux, httptest.NewRequest(http.MethodPost, "/validate", strings.NewReader(invalid)))
...
func TestJWTSignThenVerify(t *testing.T) {
	...
	rec, body := do(t, mux, httptest.NewRequest(http.MethodGet, "/jwt/sign", nil))
	if rec.Code != http.StatusOK {
