// database/redis (portable ioredis default): the injectable Redis adapter's
// default impl. Bun entries swap in a Bun.RedisClient-backed impl via
// setRedisRepositoryFactory (PLAN §3).

import { Redis } from "ioredis";
import type { UserRepository } from "./db-types.ts";
import { generateId } from "./id.ts";
import { buildUser, type CreateUser, type UpdateUser, type User } from "./schemas.ts";
