...
| ------------------- | -------------------- | ---- | ---------------- | ----------------------- | -------------------- | ---------------- | ------------------------- |
| **Node.js** v25.3.0 | **Express** v5.0.1   | 3001 | ✅ Done           | `pg` (Raw)              | `mongoose`           | `redis`          | `zod`                     |
| **Node.js** v25.3.0 | **NestJS** v10.4.15  | 3002 | ✅ Done           | `TypeORM`               | `mongoose`           | `ioredis`        | `zod` / `class-validator` |
| **Node.js** v25.3.0 | **Fastify** v5.2.0   | 3003 | ✅ Done           | `prisma`                | `mongodb`            | `@fastify/redis` | `typebox`                 |
| **Deno** v2.6.5     | **Oak** v17.1.3      | 3004 | 🚧 In Progress    | `postgres.js`           | `mongodb`            | `redis`          | `zod`                     |
| **Bun** v1.3.6      | **Hono** v4.6.14     | 3005 | ✅ Done           | `drizzle-orm`           | `mongoose`           | `ioredis`        | `arktype`                 |
| **Bun** v1.3.6      | **Elysia** v1.1.26   | 3006 | 🚧 In Progress    | `bun:sql`               | `mongoose`           | `ioredis`        | `typebox` (Built-in)      |
| **Python** v3.14.2  | **FastAPI** v0.115.6 | 4001 | ✅ Done           | `SQLAlchemy` (Async)    | `Motor` + `Beanie`   | `redis-py`       | `Pydantic` v2             |
| **Python** v3.14.2  | **Flask** v3.1.0     | 4002 | 🚧 In Progress    | `SQLAlchemy` (Core)     | `PyMongo`            | `redis-py`       | `Marshmallow`             |
| **Python** v3.14.2  | **Django** v5.1.4    | 4003 | 🚧 In Progress    | `Django ORM`            | `Djongo`             | `django-redis`   | `Django Forms`            |
| **Go** v1.25.6      | **Chi** v5.2.0       | 5001 | ✅ Done           | `pgx` (Raw)             | `mongo-go-driver`    | `go-redis`       | `go-playground/validator` |
| **Go** v1.25.6      | **Gin** v1.10.0      | 5002 | ✅ Done           | `GORM`                  | `mongo-go-driver`    | `go-redis`       | `go-playground/validator` |
| **Go** v1.25.6      | **Fiber** v2.52.5    | 5003 | ✅ Done           | `sqlc`                  | `mongo-go-driver`    | `go-redis`       | `go-playground/validator` |
| **Go** v1.25.6      | **Echo** v4.13.3     | 5004 | 🚧 In Progress    | `bun`                   | `mongo-go-driver`    | `go-redis`       | `go-playground/validator` |
